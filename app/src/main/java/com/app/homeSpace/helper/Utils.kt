...
import com.app.homeSpace.displayImage.CameraPath
import com.app.homeSpace.helper.CameraUtils.getOutputMediaFile
import com.app.homeSpace.helper.Constants.Companion.MAX_IMAGE_DIMENSION
import com.app.homeSpace.helper.Constants.Companion.QUALITY_FACTOR
                ...
                try {
                    ...
                    if (inputStream != null) {
                        ...
                        if (width > height) {
                            ...
                            val MAX_IMAGE_HEIGHT = height * MAX_IMAGE_DIMENSION / width
                            ...
                            val MAX_IMAGE_WIDTH = width * MAX_IMAGE_DIMENSION / height
                            mBitmap1 = Bitmap.createScaledBitmap(
                                pictureBitmap,
                                MAX_IMAGE_WIDTH,
                                MAX_IMAGE_DIMENSION,
                        ...
                        fOutputStream.flush()
                        fOutputStream.close()
                        thePath = fileCompressed.getAbsolutePath()
                    }
                } catch (e: Exception) {
